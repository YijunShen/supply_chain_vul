...
class Resolve:
    def __init__(self, log = True, driver=True):
        ...
        self.url = "neo4j://xxx" # the address of neo4j
    ...
    def solve_pkg(self, group, artifact, version, download=True, includedeps=True, depdep=True, cgdealer="/src/util/0414.jar"):
