...
class Jardealer:
    ...
    def __init__(self, txtdirname="cgtxt/", jsondirname="classjson/", log=True):
        self.jarroot = "/data/jars/"
        self.cgroot = "/data/cgdata/"
    ...
    def deal_jars_under(self, cgdealer, path):
        ...
        filename = "/data/jars/fail_cg_0503.json"
    ...
    def getClassPkgDict(self, group, artifact, version, cgdealer="/src/util/0414.jar"):
        rlt = {}
